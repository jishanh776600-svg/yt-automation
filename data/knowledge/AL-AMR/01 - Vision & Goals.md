...
- **The First 2 Seconds Rule:** Every Short opens with an intense curiosity gapâ€”a documented bizarre fact or mystery that makes swiping away psychologically difficult.
...
- **Strict Niche Lock:** Exclusively covers *History / Historical Mysteries / Bizarre True Historical Events / Unexplained Historical Stories*.
...
- **Local Neural Inference:** Voiceover narration is synthesized using Kokoro-82M ONNXâ€”delivering studio-grade American English delivery with zero GPU cost and zero per-character cloud API fees.
...
|---|---|---|
| **Authoritative Voice** | Strictly `af_bella` (Bella - US Female at native 1.00x) | Fail-closed in `TTSEngine` & QA |
| **Duration Target** | 22.0s â€“ 25.0s (Target: ~23.2s) | Hard rejection outside [22.0, 25.0]s |
| **Script Word Count** | Exactly 62 to 70 words | Evaluated by Council Quality Gate |
| **Pacing Gaps** | Max pause < 0.35s; dead air â‰¤ 18% | Audio waveform inspection in QA |
| **Scene Count** | Minimum 9 unique scenes (target 10â€“12) | Manifest cut count validation |
